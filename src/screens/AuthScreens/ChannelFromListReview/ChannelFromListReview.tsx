...
import { addChanneling, redeemUserRewards } from "../../../api/channeling";
...
const ChannelFromListReview = () => {
  ...
  const onSubmit = async () => {
    const payload = {
      ...
      payment: channelingData.payment
    };
    ...
    if (apiError) {
      ...
      const { apiSuccess: redeemSuccess, apiError: redeemError } =
        await redeemUserRewards(user.data.otherDetails._id, 300);
...
export default ChannelFromListReview;
