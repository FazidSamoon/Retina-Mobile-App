        ...
        <Animated.View style={[styles.modalContent, { opacity: fadeAnim }]}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {translations[language].glucose.title}
            </Text>
          ...
          <ScrollView style={styles.scrollContainer}>
            ...
            <Image
            source={require("../../../../assets/RetinoImages/thhhh.png")} // Replace with your GIF path or URL
            style={styles.gifImage}
          />
              <Text style={styles.infoText}>
                {translations[language].glucose.info}
              </Text>
            </View>

            <View style={styles.stepsContainer}>
              <Text style={styles.stepsTitle}>
                {translations[language].glucose.stepsTitle}{" "}
                {/* Use translation for stepsTitle */}
              </Text>
              {translations[language].glucose.steps.map((step, index) => (
            ...
            <View style={styles.stepsContainer}>
              <Text style={styles.stepsTitle}>
                {translations[language].glucose.report}{" "}
                {/* Use translation for stepsTitle */}
              </Text>
            </View>
