        ...
        <Animated.View style={[styles.modalContent, { opacity: fadeAnim }]}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {translations[language].bloodPressure.title}
            </Text>
          ...
          />
            ...
            <View style={styles.stepsContainer}>
              <Text style={styles.stepsTitle}>
                {translations[language].bloodPressure.stepsTitle}{" "}
                {/* Use translation for stepsTitle */}
              </Text>
              {translations[language].bloodPressure.steps.map((step, index) => (
            ...
            <View style={styles.stepsContainer}>
              <Text style={styles.stepsTitle}>
                {translations[language].bloodPressure.report}{" "}
                {/* Use translation for stepsTitle */}
              </Text>
            </View>
