        ...
        <Animated.View style={[styles.modalContent, { opacity: fadeAnim }]}>
          <ScrollView contentContainerStyle={styles.scrollViewContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>{translations[language].insulin.title}</Text>
            ...
            <View style={styles.infoContainer}>
              <Ionicons name="medkit-outline" size={50} color="#FF4500" style={styles.infoIcon} />
              <Text style={styles.infoText}>{translations[language].insulin.info}</Text>
            </View>
          </ScrollView>
        </Animated.View>
      </Modal>
