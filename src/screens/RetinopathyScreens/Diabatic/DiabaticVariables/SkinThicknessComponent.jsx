        ...
        <Animated.View style={[styles.modalContent, { opacity: fadeAnim }]}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {translations[language].skinThickness.title}
            </Text>
          ...
          <ScrollView style={styles.scrollContainer}>
            ...
            <Image
            source={require("../../../../assets/RetinoImages/25.png")} // Replace with your GIF path or URL
            style={styles.gifImage}
          />
              <Text style={styles.infoText}>
                {translations[language].skinThickness.info}
              </Text>
            </View>

            <View style={styles.stepsContainer}>
              <Text style={styles.stepsTitle}>
                {translations[language].skinThickness.stepsTitle}{" "}
                {/* Use translation for stepsTitle */}
              </Text>
              {translations[language].skinThickness.steps.map((step, index) => (
            ...
            <View style={styles.stepsContainer}>
              <Text style={styles.stepsTitle}>
                {translations[language].skinThickness.report}{" "}
                {/* Use translation for stepsTitle */}
              </Text>
            </View>
