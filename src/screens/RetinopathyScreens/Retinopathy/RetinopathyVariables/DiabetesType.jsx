        ...
        <Animated.View style={[styles.modalContent, { opacity: fadeAnim }]}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {translations[language].diabetesType.title}
            </Text>
          ...
          <ScrollView style={styles.scrollContainer}>
            ...
            <Image
            source={require("../../../../assets/RetinoImages/21.png")} // Replace with your GIF path or URL
            style={styles.gifImage}
          />
              <Text style={styles.infoText}>
                {translations[language].diabetesType.info}
              </Text>
            </View>

            <View style={styles.stepsContainer}>
              <Text style={styles.stepsTitle}>
                {translations[language].diabetesType.stepsTitle}
              </Text>
              {translations[language].diabetesType.steps.map((step, index) => (
            ...
            <View style={styles.reportDetailsContainer}>
              <Text style={styles.reportDetailsText}>
                {translations[language].diabetesType.report}
              </Text>
            </View>
          </ScrollView>
