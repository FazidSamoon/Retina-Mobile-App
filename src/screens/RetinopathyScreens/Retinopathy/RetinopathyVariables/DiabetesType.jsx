        ...
        <Animated.View style={[styles.modalContent, { opacity: fadeAnim }]}>
          <ScrollView contentContainerStyle={styles.scrollViewContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>{translations[language].diabetesType.title}</Text>
            ...
            <View style={styles.infoContainer}>
              <Ionicons name="clipboard-outline" size={50} color="#4CAF50" style={styles.infoIcon} />
              <Text style={styles.infoText}>{translations[language].diabetesType.info}</Text>
            </View>
          </ScrollView>
        </Animated.View>
      </Modal>
