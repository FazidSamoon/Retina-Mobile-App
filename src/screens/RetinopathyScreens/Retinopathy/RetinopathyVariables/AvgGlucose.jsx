        ...
        <Animated.View style={[styles.modalContent, { opacity: fadeAnim }]}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {translations[language].avgGlucose.title}
            </Text>
          ...
          />
              <Text style={styles.infoText}>
                {translations[language].avgGlucose.info}
              </Text>
            </View>

            <View style={styles.stepsContainer}>
              <Text style={styles.stepsTitle}>
                {translations[language].avgGlucose.stepsTitle}
              </Text>
              {translations[language].avgGlucose.steps.map((step, index) => (
            ...
            <View style={styles.reportDetailsContainer}>
              <Text style={styles.reportDetailsText}>
                {translations[language].avgGlucose.report}
              </Text>
            </View>
          </ScrollView>
