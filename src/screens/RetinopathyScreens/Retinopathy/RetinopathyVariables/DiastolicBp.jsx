        ...
        <Animated.View style={[styles.modalContent, { opacity: fadeAnim }]}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {translations[language].diastolicBp.title}
            </Text>
          ...
          /> */}
            ...
            <View style={styles.stepsContainer}>
              <Text style={styles.stepsTitle}>
                {translations[language].diastolicBp.stepsTitle}
              </Text>
              {translations[language].diastolicBp.steps.map((step, index) => (
            ...
            <View style={styles.reportDetailsContainer}>
              <Text style={styles.reportDetailsText}>
                {translations[language].diastolicBp.report}
              </Text>
            </View>
          </ScrollView>
