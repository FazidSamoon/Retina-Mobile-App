        ...
        <Animated.View style={[styles.modalContent, { opacity: fadeAnim }]}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {translations[language].hba1c.title}
            </Text>
          ...
          <ScrollView style={styles.scrollContainer}>
            ...
            <Image
            source={require("../../../../assets/RetinoImages/22.png")} // Replace with your GIF path or URL
            style={styles.gifImage}
          />
              <Text style={styles.infoText}>
                {translations[language].hba1c.info}
              </Text>
            </View>

            <View style={styles.stepsContainer}>
              <Text style={styles.stepsTitle}>
                {translations[language].hba1c.stepsTitle}
              </Text>
              {translations[language].hba1c.steps.map((step, index) => (
            ...
            <View style={styles.reportDetailsContainer}>
              <Text style={styles.reportDetailsText}>
                {translations[language].hba1c.report}
              </Text>
            </View>
          </ScrollView>
