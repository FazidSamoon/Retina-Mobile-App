        ...
        <Animated.View style={[styles.modalContent, { opacity: fadeAnim }]}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {translations[language].systolicBp.title}
            </Text>
          ...
          /> */}
            ...
            <View style={styles.stepsContainer}>
              <Text style={styles.stepsTitle}>
                {translations[language].systolicBp.stepsTitle}
              </Text>
              {translations[language].systolicBp.steps.map((step, index) => (
            ...
            <View style={styles.reportDetailsContainer}>
              <Text style={styles.reportDetailsText}>
                {translations[language].systolicBp.report}
              </Text>
            </View>
          </ScrollView>
